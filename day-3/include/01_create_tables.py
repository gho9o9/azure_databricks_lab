...
table_name = table_name_prefix + "account"
schema = """
`Id` STRING NOT NULL, 
`IsDeleted` BOOLEAN, 
...
table_name = table_name_prefix + "contact"
schema = """
`Id` STRING NOT NULL,
`IsDeleted` BOOLEAN,
`MasterRecordId` STRING,
...
table_name = table_name_prefix + "lead"
schema = """
`Id` STRING NOT NULL,
`IsDeleted` BOOLEAN,
`MasterRecordId` STRING,
...
table_name = table_name_prefix + "campaign"
schema = """
`Id` STRING NOT NULL,
`IsDeleted` BOOLEAN,
`Name` STRING,
...
table_name = table_name_prefix + "opportunity"
schema = """
`Id` STRING NOT NULL,
`IsDeleted` BOOLEAN,
`AccountId` STRING,
...
table_name = table_name_prefix + "product2"
schema = """
`Id` STRING NOT NULL,
`Name` STRING,
`ProductCode` STRING,
...
table_name = table_name_prefix + "pricebook_entry"
schema = """
`Id` STRING NOT NULL,
`Name` STRING,
`Pricebook2Id` STRING,
...
table_name = table_name_prefix + "case"
schema = """
`Id` STRING NOT NULL,
`IsDeleted` BOOLEAN,
`MasterRecordId` STRING,
...
table_name = table_name_prefix + "user"
schema = """
`Id` STRING NOT NULL,
`Username` STRING,
`LastName` STRING,
...
table_name = table_name_prefix + "order"
schema = """
`Id` STRING NOT NULL,
`OwnerId` STRING,
`ContractId` STRING,
